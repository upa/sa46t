...
Example)  
how to use sa46t with plane id 99, and IPv4 prefix
`10.0.0.0/24`, and mapping IPv6 prefix `2001:db8:1:1::/64`.
...
SA46T1 advertises prefix `2001:db8:1:1:99::a00:0/120` on Backbone
...
addrss of Encapsulated packets is `2001:db8:1:1:99::a00:X`. Thereby
...
### SA46T1 ###
	 ...
	 # Redistribute 2001:db8:1:1:99::a00:0/108 to Backbone Network using any routing daemonds.
...
### SA46T2 ###
	 ...
	 % sudo ip -6 route add to 2001:db8:1:1::/96 dev sa46t
	  
	 # Redistribute 10.0.0.0/24 to IPv4 Network, and 
	 # 2001:db8:1:1::/96 to Backbone Network using any routing daemons.

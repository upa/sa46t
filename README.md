...
SA46T1 advertises prefix `2001:db8:1:1:99::a000/120` on Backbone
...
`2001:db8:1:1:99::a00X`. Thereby encapsulated packets arrives at
SA46T1. Then, packets are decapsulated and sent to the Stub Network.
